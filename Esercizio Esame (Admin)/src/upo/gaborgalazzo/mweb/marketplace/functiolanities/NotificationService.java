...
public class NotificationService
{
	public static void productReturnedAvailable(Product product, User user)
	{
		...
		Email email = EmailBuilder.startingBlank()
				...
				.withHTMLText("The product <a href='http://localhost:8000/product.php?id="+product.getId()+"'>\""+product.getName()+"\"</a> has returned available")
				.buildEmail();
	...
	{
		Mailer mailer = MailerBuilder
				.withSMTPServer("smtp.gmail.com", 465, "20024195@studenti.uniupo.it", "Pinguino98!")
				.withTransportStrategy(TransportStrategy.SMTPS)
