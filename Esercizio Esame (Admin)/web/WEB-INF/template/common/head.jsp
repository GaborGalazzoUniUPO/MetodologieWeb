<head>
	...
	<!-- jQuery -->
	<script src="${pageContext.request.contextPath}/assets/js/jquery-2.0.0.min.js" type="text/javascript"></script>
	...
	<!-- Font awesome 5 -->
	<link href="${pageContext.request.contextPath}/assets/fonts/fontawesome/css/fontawesome-all.min.css" type="text/css" rel="stylesheet">
